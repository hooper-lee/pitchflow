...
- Credits 与上下文：run 前额度检查、普通对话 usage、Planner usage、Tool usage、套餐级上下文裁剪
...
- Admin 监控：Agent 工具、套餐策略、运行记录、Tool Calls、Usage、审批记录、Channel Bindings、MCP Gateway 状态页
...
- **Agent 工具** `(/admin/agent-tools)`：Agent 套餐策略、工具权限、风险等级、Credits
